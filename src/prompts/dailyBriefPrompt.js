...
- 在“随机拓展”里，优先加入 1 条 Stanford 课程知识卡片，定位为“每天学点知识”；优先使用 Stanford MS&E 435 课程材料（https://mse435.stanford.edu/materials.html）或其他可核验的 Stanford 课程公开材料，讲清楚一个课程概念、框架或方法
- 若“关注清单”当天无实质变化，可以省略
...
- “随机拓展”写 1-2 条：
  - 优先 1 条 Stanford 课程知识卡片，按“主题 / 今天学到什么 / 为什么值得学 / 和当下 AI、商业或投资框架有什么连接 / 来源”来写
  - 如有足够高质量、且与核心主线不同但值得扩展视野的新闻，可再加 1 条，并说明为什么选它
...
- Stanford 课程材料可作为“随机拓展”的稳定知识源，目标是形成“每天学点知识”的长期栏目；不要机械复述课程目录，而是提炼一个具体概念、框架、案例或问题意识，优先选择对理解 AI、算力、数据中心、企业 AI、GPU 经济、平台竞争或 token economics 有帮助的内容
...
- 如果引用 Stanford 课程材料，必须明确写出课程主题或材料标题；它可以独立作为“今日学习”内容出现，不必强行伪装成当天新闻，但要说明这条知识为什么值得今天学
...
- 可以把 Stanford 课程材料作为“随机拓展”的优先来源，每天 1 条即可；目标是帮助收件人稳定积累知识，而不是只在当天新闻需要时才出现
...
- 如引用 Stanford 课程材料，必须把它写成“课程知识卡片/框架拓展”，不能冒充新闻更新

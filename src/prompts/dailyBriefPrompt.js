...
const AI_APPLICATION_LAYER_RULES = `
- “科技与 AI”不能只盯模型、芯片和数据中心；每天都应主动检查 AI 应用层动态，优先覆盖市场当前最关注的应用方向，例如 AI coding、AI 搜索、agent、企业 AI copilot、客服/销售自动化、设计/视频生成、AI 原生 SaaS、垂直行业应用
- 如果过去 24 小时内应用层有实质更新，优先写清：现在市场在关注哪些 AI 应用、哪些产品或公司拿到了用户增长/付费/分发优势、哪些方向还只是高热度但低变现
- “科技投资观察”若涉及 AI 应用层，尽量明确商业模式：订阅、按 seat 收费、usage/token 计费、分成 marketplace、广告、企业 license、效果付费，或混合模式；并说明当前更像收入验证、估值叙事，还是刚起步的 adoption 信号
`;
...
${AI_APPLICATION_LAYER_RULES.trim()}
...
- 科技与 AI：在基础模型与算力之外，优先主动补充 AI 应用层动态，说明当前市场最关注的应用方向、产品分发、用户增长和付费验证
- 科技投资观察：重点围绕 VGT、SMH、半导体、云计算、AI 基础设施、主要科技公司资本开支与产业链影响
- 科技投资观察：若写到 AI 应用层，尽量同时说明“大家现在关注的应用是什么”和“它靠什么盈利”，并区分收入验证与叙事交易
